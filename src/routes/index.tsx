      ...
      <div className="relative flex items-center justify-between">
        ...
        {stages.map((s) => (
          <div key={s} className="relative flex flex-col items-center gap-3">
            <span
              className="relative z-10 h-4 w-4 rounded-full bg-gradient-to-br from-teal-300 to-lime-300"
...
function Index() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 sm:px-8 py-16 sm:py-24 space-y-20">
      ...
      {/* About */}
      <motion.section {...fadeUp} className="glass-card px-6 sm:px-12 py-10 space-y-4">
